...
<div style="margin-bottom: 24px; border-bottom: 1px solid var(--md-sys-color-surface-variant);">
...
function showTab(tab) {
    ...
    if (tab === 'pending') {
        btnPending.style.borderBottom = '2px solid var(--md-sys-color-primary)';
        btnPending.style.color = 'var(--md-sys-color-primary)';
        btnPending.style.fontWeight = '700';
        
        btnHistory.style.borderBottom = 'none';
        btnHistory.style.color = 'var(--md-sys-color-outline)';
        btnHistory.style.fontWeight = 'normal';
    } else {
        btnHistory.style.borderBottom = '2px solid var(--md-sys-color-primary)';
        btnHistory.style.color = 'var(--md-sys-color-primary)';
        btnHistory.style.fontWeight = '700';
        
        btnPending.style.borderBottom = 'none';
        btnPending.style.color = 'var(--md-sys-color-outline)';
        btnPending.style.fontWeight = 'normal';
    }
}
</script>
